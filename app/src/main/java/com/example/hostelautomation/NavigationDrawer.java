...
public class NavigationDrawer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuItems.add(new MenuItem("Scene",R.drawable.news_bg));
        menuItems.add(new MenuItem("Schedule",R.drawable.feed_bg));
      ...
      //  sNavigationDrawer.setBackground(greenColorValue);
